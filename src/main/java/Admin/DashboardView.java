...
public class DashboardView {
    ...
    private VBox buildCard(String title, VBox content) {
        ...
        cardHeader.setStyle("-fx-border-color: #eeeeee; -fx-border-width: 0 0 1 0;");
    ...
    private VBox buildAccountTable(List<TAApplication> tas, List<User> mos) {
        ...
        if (tas.isEmpty() && mos.isEmpty()) {
            ...
            empty.setStyle("-fx-font-size: 13px; -fx-text-fill: #aaaaaa; -fx-padding: 20 20 20 20;");
    ...
    private VBox buildRecentLogs(List<LogManager.LogEntry> logs) {
        ...
        for (LogManager.LogEntry entry : recent) {
            ...
            logRow.setStyle("-fx-border-color: #eeeeee; -fx-border-width: 0 0 1 0;");
            ...
            text.setStyle("-fx-font-size: 13px; -fx-text-fill: #333333;");
            HBox.setHgrow(text, Priority.ALWAYS);

            Label time = new Label(entry.getTimestamp());
            time.setStyle("-fx-font-size: 11px; -fx-text-fill: #aaaaaa;");
